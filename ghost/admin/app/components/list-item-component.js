// app/components/list-item-component.js
...
export default class ListItemComponent extends Component {
  ...
  @tracked socialPlatforms = [...defaultPlatforms];

  @action
  togglePlatform(name) {
    const platform = this.socialPlatforms.find(p => p.name === name);
    if (platform) {
      platform.selected = !platform.selected;
      this.socialPlatforms = [...this.socialPlatforms];
    }
  }
